...
def create_toggle_and_children(token, page_id, question_text):
    ...
    # Essential sleep to let Notion finish block creation
    time.sleep(1.2)
    
    # 2. Define and Add Children (Fixed Icon Structure)
    ...
    # Retry logic for the children block
...
if __name__ == "__main__":
    ...
    header_blocks = [
        {
            "object": "block",
            "type": "heading_2",
            "heading_2": {"rich_text": [{"type": "text", "text": {"content": "📅 AI 應用規劃師中級模擬練習 - 2026-04-27 (v2.6)"}}] }
        },
        {
            "object": "block",
            "type": "paragraph",
    ...
    print("Successfully generated v2.6 Exam. Guaranteed structure and full 10 questions.")
