...
def create_toggle_and_children(token, page_id, question_text):
    ...
    # Retry loop for adding children to handle Notion's eventual consistency
...
if __name__ == "__main__":
    ...
    header_blocks = [
        {
            "object": "block",
            "type": "heading_2",
            "heading_2": {"rich_text": [{"type": "text", "text": {"content": "📅 AI 應用規劃師中級模擬練習 - 2026-04-27 (v2.4)"}}] }
        },
        {
            "object": "block",
            "type": "paragraph",
            "paragraph": {"rich_text": [{"type": "text", "text": {"content": "✏️ **填答指南**：展開題目 $\rightarrow$ 在 ✏️ 區塊輸入答案 $\rightarrow$ 告知小白批改。"}}] }
        }
    ]
    ...
    print("Successfully generated v2.4 Exam. All 10 questions created with retry logic.")
