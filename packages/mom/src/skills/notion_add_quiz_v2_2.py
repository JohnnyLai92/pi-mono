...
def create_toggle_and_children(token, page_id, question_text):
    ...
    # IMPORTANT: Adding a small sleep to ensure Notion backend processes the block before adding children
    time.sleep(0.5)
...
if __name__ == "__main__":
    ...
    header_blocks = [
        {
            "object": "block",
            "type": "heading_2",
            "heading_2": {"rich_text": [{"type": "text", "text": {"content": "📅 AI 應用規劃師中級模擬練習 - 2026-04-27 (v2.2)"}}] }
        },
        {
            "object": "block",
            "type": "paragraph",
    ...
    print("Successfully generated v2.2 Exam with 10 Questions and guaranteed Callouts.")
