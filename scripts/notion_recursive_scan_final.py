...
class NotionRecursiveScanner:
    ...
    def scan(self, page_id, depth=0):
        ...
        indent = "  " * depth
        print(f"{indent}[INFO] Scanning Page ID: {page_id}")
        ...
        try:
            ...
            if page_res.status_code == 200:
                ...
                print(f"{indent}[WARN] Could not fetch page title (Status: {page_res.status_code})")
            ...
            for block in blocks:
                ...
                # 處理資料庫 (遞迴進入資料庫)
                    ...
                    print(f"{indent}  [DATABASE] Found Database. Scanning rows...")
    ...
    def scan_database(self, db_id, depth):
        ...
        try:
            ...
            print(f"{indent}  [ERROR] DB scan failed: {e}")
